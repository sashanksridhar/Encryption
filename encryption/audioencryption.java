...
File encryptedFile = new File(path1+"encrypted.mp3");
 try
...
File outputFile = new File(path1 + "decrypted.mp3");
audioencryption.fileProcessor(Cipher.DECRYPT_MODE,key,inputFile,outputFile);
